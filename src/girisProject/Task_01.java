...
public class Task_01 {
    public static void main(String[] args) {
        /*TODO
                ...
                2- Registration(Kayıt) isminde bir class oluşturun ve register()(kayıtAl()) isminde
                bir metod create ederek Kullanıcı Class'dan user ismini(name) alarak ArrayList e ekleyin
                ve bu list i   return edin.
